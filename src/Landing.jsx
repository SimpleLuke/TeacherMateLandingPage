	  ...
	  <div className="w-full flex justify-center">
        ...
        <div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
          <h2 className="text-center text-lg font-semibold leading-8 text-white">
				Founders from the most innovative institutes
          </h2>
          <div className="mx-auto mt-10 grid max-w-lg grid-cols-3 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <img
              className="col-span-2 max-h-ful w-full object-contain lg:col-span-1"
              src="https://42london.com/wp-content/uploads/2024/01/42-London-logo.jpg"
              alt="Transistor"
              width={214}
              height={142.66}
            />
            <img
              ...
              src="https://42london.com/wp-content/uploads/2024/01/London-Interdisciplinary-School-logo.jpg"
              alt="Reform"
              width={214}
              height={142.66}
            />
            <img
              className="col-span-2 max-h-full w-full object-contain lg:col-span-1"
              src="https://42london.com/wp-content/uploads/2024/01/City-University-of-London-Logo.jpg"
              alt="Tuple"
              width={214}
              height={142.66}
            />
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-4 lg:px-8">
          <div className="border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; 2024 Teacher Mate, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
